...
class TestFullPipeline:
    ...
    def sample_clause(self):
        return """
        Force Majeure: Neither party shall be liable for any failure or delay 
        in performing its obligations under this Agreement where such failure 
        or delay results from circumstances beyond the reasonable control of 
        that party, including but not limited to acts of God, natural disasters, 
        war, terrorism, riots, or government action.
        """
    ...
    def liability_clause(self):
        ...
        or other intangible losses, resulting from this Agreement.
        """
...
class TestAPIIntegration:
    ...
    def test_analyze_and_get_result(self, client):
        ...
        with the laws of England and Wales. The parties submit to the 
