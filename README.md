...
| Metric | Score |
|--------|-------|
| Clause Type Accuracy | **98.9%** |
| Risk Detection (Binary) | **78.5%** |
| Risk Detection (Exact) | **45.1%** |
...
# Full Contract Analysis POST /v1/analyze/contract
...
│ ┌─────────────────┐ ┌─────────────────────────────┐ │
│ │ Local (Ollama) │ OR │ Dedicated Inference Node │ │
│ │ Qwen 32B │ │ (vLLM / MLX) │ │
│ └─────────────────┘ └─────────────────────────────┘ │
└──────────────────────────────────────────────────────────────┘
```
