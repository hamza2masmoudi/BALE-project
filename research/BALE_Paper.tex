...
We evaluated the full V11 pipeline on 525 contracts: 15 from our evaluation dataset and 510 from the full CUAD corpus~\cite{hendrycks2021}, spanning 13 contract categories. Table~\ref{tab:v11eval} summarizes the innovation-specific metrics.

\begin{table}[h]
\centering
\small
\caption{V11 innovation metrics across 525 evaluation contracts. All innovations ran successfully on every contract (525/525, 0 errors).}
\label{tab:v11eval}
\begin{tabular}{lc}
\toprule
...
Avg.\ latency (full pipeline) & 229ms \\
Median latency & 218ms \\
P95 latency & 400ms \\
Max.\ latency & 2,067ms \\
Success rate & 100\% (525/525) \\
\midrule
\multicolumn{2}{l}{\textit{Calibration}} \\
Total clauses classified & 4,258 \\
Human review flagged & 4,258 (100\%) \\
Avg.\ calibrated confidence & 0.0715 \\
Avg.\ entropy ratio & 0.9999 \\
\midrule
\multicolumn{2}{l}{\textit{Rewrite Engine}} \\
Total suggestions generated & 2,117 \\
Avg.\ suggestions per contract & 4.0 \\
\midrule
\multicolumn{2}{l}{\textit{Monte Carlo Simulation}} \\
Simulations completed & 525/525 \\
Avg.\ mean risk score & 64.9 \\
\midrule
\multicolumn{2}{l}{\textit{Corpus Intelligence}} \\
Contracts ingested & 525 \\
Anomalies flagged & 416 \\
\bottomrule
\end{tabular}
\end{table}

Table~\ref{tab:v11types} shows per-contract-type breakdown across the 13 categories present in the full CUAD corpus.

\begin{table}[h]
\centering
\small
\caption{V11 per-type breakdown across 13 contract categories from the CUAD corpus.}
\label{tab:v11types}
\begin{tabular}{lrcrc}
\toprule
\textbf{Type} & \textbf{N} & \textbf{Avg Risk} & \textbf{Rewrites} & \textbf{Anomalies} \\
\midrule
MSA & 421 & 70.5 & 1,693 & 302 \\
License & 41 & 71.9 & 198 & 37 \\
Supply & 24 & 29.0 & 75 & 37 \\
Franchise & 15 & 30.8 & 68 & 17 \\
Collaboration & 11 & 32.5 & 36 & 16 \\
NDA & 5 & 56.1 & 10 & 3 \\
Loan & 2 & 26.4 & 7 & 1 \\
Other (6 types) & 6 & 40.9 & 30 & 3 \\
\bottomrule
\end{tabular}
\end{table}

\noindent The V11 pipeline processes contracts 51\% faster than V10 (229ms vs.\ 471ms average) due to optimized lazy loading of innovation modules. The Rewrite Engine generated actionable suggestions across all contract types, averaging 4.0 per contract. The high human review rate (100\%) indicates that the calibration thresholds are conservatively set---appropriate for a legal-critical system where false confidence is more dangerous than unnecessary review. Corpus Intelligence detected 416 anomalies, identifying contracts with unusual risk profiles, power asymmetries, or clause counts relative to the growing corpus baseline.
