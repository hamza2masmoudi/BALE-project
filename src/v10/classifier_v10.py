...
"fr_description": "Clause d'indemnisation. Une partie s'engage à indemniser, défendre et garantir l'autre contre les réclamations de tiers, pertes et frais d'avocats.",
"risk_weight": 0.8,
"category": "liability"
},
...
"fr_description": "Limitation de responsabilité et plafond de dommages. En aucun cas la responsabilité totale ne saurait excéder un montant déterminé. Exclut les dommages indirects.",
"risk_weight": 0.9,
"category": "liability"
},
"termination": {
...
"fr_description": "Résiliation du contrat. Chaque partie peut résilier le contrat moyennant un préavis écrit. Résiliation pour motif, pour convenance, en cas de manquement substantiel.",
"risk_weight": 0.6,
"category": "lifecycle"
},
"confidentiality": {
...
"fr_description": "Obligations de non-divulgation. Protège les informations confidentielles et propriétaires partagées entre les parties.",
"risk_weight": 0.5,
...
"fr_description": "Propriété et licence des droits de propriété intellectuelle. Brevets, droits d'auteur, marques.",
"risk_weight": 0.7,
"category": "ip"
},
"governing_law": {
...
"fr_description": "Choix de juridiction et droit applicable régissant le contrat. Loi applicable à l'interprétation.",
"risk_weight": 0.3,
"category": "governance"
},
"force_majeure": {
...
"fr_description": "Force majeure et cas fortuit. Aucune partie ne sera responsable en cas d'inexécution due à des circonstances indépendantes de sa volonté: catastrophe naturelle, pandémie, guerre, grève.",
"risk_weight": 0.6,
...
"fr_description": "Garanties sur la qualité, la performance, l'état ou l'aptitude à l'emploi. Garanties expresses ou implicites.",
"risk_weight": 0.6,
"category": "quality"
},
"payment_terms": {
"description": "Pricing, fees, invoicing schedule, payment deadlines, late payment penalties, interest on overdue payments.",
"fr_description": "Tarification, frais, calendrier de facturation, délais de paiement, pénalités de retard.",
"risk_weight": 0.5,
"category": "financial"
},
"non_compete": {
...
"fr_description": "Restrictions sur les activités concurrentielles pendant et après le contrat. Non-sollicitation.",
"risk_weight": 0.8,
...
"fr_description": "Obligations de conformité RGPD, protection des données personnelles, droits des personnes concernées.",
"risk_weight": 0.7,
"category": "compliance"
},
"assignment": {
...
"fr_description": "Transfert des droits ou obligations à des tiers. Cession, délégation ou novation du contrat.",
"risk_weight": 0.4,
"category": "governance"
},
"dispute_resolution": {
...
"fr_description": "Procédures d'arbitrage, de médiation ou de contentieux pour résoudre les différends.",
"risk_weight": 0.5,
"category": "governance"
},
"insurance": {
...
"fr_description": "Droits d'inspecter les livres, registres, systèmes ou la conformité. Audits financiers et de sécurité.",
"risk_weight": 0.4,
"category": "compliance"
},
}
...
Returns ClassificationResult with type, confidence, and top-3.
"""
start = time.time()
# Encode input
...
global _classifier
_classifier = None
__all__ = ["EmbeddingClassifier", "ClassificationResult", "CLAUSE_TAXONOMY", "get_classifier", "reset_classifier"]
