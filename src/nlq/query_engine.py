...
class NLQueryEngine:
    ...
    def _handle_renewal_timeline(self, query: str) -> Tuple[str, Dict, List]:
        ...
        answer += "⚠️ *Note: Renewal dates require contract metadata integration.*\n\n"
    ...
    def _handle_party_analysis(self, query: str) -> Tuple[str, Dict, List]:
        ...
        for e in entities[:10]:
            trend_emoji = "📈" if e.risk_trend == "increasing" else "📉" if e.risk_trend == "decreasing" else "➡️"
    ...
    def _handle_general(self, query: str) -> Tuple[str, Dict, List]:
        ...
        answer += "⚖️ **Comparisons** - 'How do my terms compare to market?'\n"
