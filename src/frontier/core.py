...
ContractType.NDA: [
ClauseTemplate("confidentiality", "Core confidentiality obligations", ["confidential", "proprietary"], 0.99, 50, "core"),
ClauseTemplate("term", "Duration of confidentiality", ["term", "duration", "period"], 0.95, 20, "temporal"),
ClauseTemplate("exclusions", "Exclusions from confidentiality", ["exclusions", "does not include", "excepted"], 0.85, 15, "scope"),
ClauseTemplate("return_materials", "Return of confidential materials", ["return", "destroy", "materials"], 0.75, 10, "operational"),
ClauseTemplate("injunctive_relief", "Right to seek injunction", ["injunctive", "irreparable harm"], 0.60, 5, "remedies"),
],
ContractType.SLA: [
ClauseTemplate("uptime", "Uptime/availability commitment", ["uptime", "availability", "99."], 0.95, 40, "performance"),
ClauseTemplate("credits", "Service credits for outages", ["credit", "refund", "compensation"], 0.85, 25, "remedies"),
ClauseTemplate("exclusions", "SLA exclusions", ["excluded", "does not apply", "maintenance"], 0.80, 15, "scope"),
ClauseTemplate("measurement", "How metrics are measured", ["measured", "calculated", "monitoring"], 0.70, 10, "operational"),
],
ContractType.MSA: [
ClauseTemplate("scope", "Scope of services", ["scope", "services", "deliverables"], 0.99, 35, "core"),
ClauseTemplate("payment", "Payment terms", ["payment", "invoice", "fees"], 0.98, 30, "commercial"),
ClauseTemplate("limitation_liability", "Liability caps", ["limitation", "liability", "cap"], 0.90, 25, "risk"),
ClauseTemplate("indemnification", "Indemnification provisions", ["indemnify", "hold harmless"], 0.85, 20, "risk"),
ClauseTemplate("termination", "Termination rights", ["termination", "terminate", "cancel"], 0.95, 20, "exit"),
ClauseTemplate("ip_ownership", "IP ownership provisions", ["intellectual property", "ownership", "work product"], 0.80, 25, "ip"),
],
ContractType.EMPLOYMENT: [
ClauseTemplate("compensation", "Salary and benefits", ["salary", "compensation", "benefits"], 0.99, 40, "commercial"),
ClauseTemplate("duties", "Job duties and responsibilities", ["duties", "responsibilities", "position"], 0.95, 25, "core"),
ClauseTemplate("termination", "Termination conditions", ["termination", "at-will", "notice period"], 0.90, 30, "exit"),
ClauseTemplate("non_compete", "Non-compete clause", ["non-compete", "competitive", "not engage"], 0.50, 15, "restrictive"),
ClauseTemplate("ip_assignment", "IP assignment to employer", ["inventions", "work product", "assign"], 0.75, 20, "ip"),
],
}
