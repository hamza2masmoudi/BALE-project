...
LegalRule.CONTRA_PROFERENTEM: "Ambiguous terms are interpreted against the drafter",
...
evidence=context.get("ambiguity_evidence", "Clause contains ambiguous/vague terminology" if factors.is_ambiguous else "Clause language is clear and unambiguous"),
...
self, clause_text: str, current_risk: int,
