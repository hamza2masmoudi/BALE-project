...
base = ["recitals", "definitions", "services", "fees", "term_termination", "ip", "confidentiality", "warranties", "indemnification", "limitation_of_liability", "force_majeure", "dispute_resolution", "general", "signature"]
if contract_type.lower() == "nda":
return ["recitals", "definitions", "services", "confidentiality", "term_termination", "general", "signature"]
elif contract_type.lower() == "sla":
return ["recitals", "services", "term_termination", "limitation_of_liability", "general", "signature"]
return base
