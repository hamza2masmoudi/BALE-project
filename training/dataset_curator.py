...
INSTRUCTIONS = {
"interpretation": """You are a legal expert analyzing contract clauses. Interpret the following clause from both Civil Law (French Code Civil) and Common Law (English Law) perspectives.
